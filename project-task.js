...
function processFile(fileName, fileData) {
  try {
    ...
    if (fileName === undefined || fileName === "") { // This catches undefined and empty strings
    ...
    console.log(`Reading file data: ${fileData}`);
  ...
  // TODO: Implement a finally block to close resources
    ...
    if (isFileOpen = true) {
      console.log(`${fileName} is opened. Closing ${fileName} now`);
      isFileOpen = false;
    } else {
      console.log("No files are open.")
    }
  }
}
